        ...
        <>
            {sidebarOpen && (
                <div
                    ...
                    className="fixed inset-0 bg-black/60 backdrop-blur-[1px] z-40 md:hidden"
                />
            )}
            ...
            >
                                ...
                                return (
                                    <li key={item.label}>
                                        <Link
                                            ...
                                            onClick={() => setSidebarOpen(false)}
                                            className={`
                                                relative group flex items-center gap-3 w-full px-4 py-3
                                        ...
                                        >
                                            {active && (
                                                <span className="absolute right-4 text-green-400 opacity-70 font-bold">
                                                    {"›"}
                                                </span>
                                            )}
                ...
                <div className="px-4 pb-4 border-t border-white/10 pt-4 shrink-0">
                    <div className="bg-[#1F2937] rounded-2xl p-2.5 flex items-center gap-3 mb-3">
                        <AvatarUser />
